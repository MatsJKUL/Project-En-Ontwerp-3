...
while run:
    ...
    for number in range(len(players)):
        ...
        for hand_index in range(len(players[number].status())):
            ...
            print("Your cards:",players[number].status()[hand_index][0],"and points:",players[number].status()[hand_index][1] )
            move = int(
            ...
            if move == 1:
                run_hit = True
                while run_hit:
                    hit(players[number], cards, deleted_cards,hand_index)
                    player_status = players[number].status()[hand_index]
                    print(
                        "You have",
                        player_status[0],
                        "as cards and:",
                ...
                double(players[number], cards, deleted_cards,hand_index)
                player_status = players[number].status()[hand_index]
                print(
                    "You have",
                    player_status[0],
